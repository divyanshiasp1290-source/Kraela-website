  ...
  head: () => ({
    meta: [
      ...
      { title: "Kraela — Edible Oil Manufacturer & Global Exporter" },
      {
        name: "description",
        content:
          "Kraela supplies refined edible oils and graded oilseeds to importers, food manufacturers and distributors worldwide.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Kraela" },
